...
import com.example.devices_crib.BuildConfig;
...
public class PictureBarcodeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.devices_crib_qrscan_picture_barcode_activity);
    ...
    private void takeBarcodePicture() {
        ...
        imageUri = FileProvider.getUriForFile(PictureBarcodeActivity.this,
               "devices_crib_qrscan_jpeg_file.provider" //BuildConfig.APPLICATION_ID + ".provider"
                , photo);
