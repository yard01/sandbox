...
public class DevicesCribFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TabLayout tabLayout = (TabLayout) result.findViewById(R.id.devices_tabs); //нашли TabLayout (закладки)
        ViewPager viewPager = (ViewPager) result.findViewById(R.id.devices_container); // нашли наш ViewPager
