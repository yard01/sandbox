...
public class ServiceCribFragment  extends Fragment {
    ...
    public static ServiceCribFragment newInstance(String param1, String param2) {
        ServiceCribFragment fragment = new ServiceCribFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View result = inflater.inflate(R.layout.fragment_service, container, false);
        //if (true) return;
        //result.findViewById()
        //result
        ...
        TabLayout tabLayout = (TabLayout) result.findViewById(R.id.services_crib_tabs); //нашли TabLayout (закладки)
        mViewPager = (ViewPager) result.findViewById(R.id.services_crib_container); // нашли наш ViewPager
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onDestroy() {
            super.onDestroy();
            TabContentCreator.destroyContent();
        }
    }
